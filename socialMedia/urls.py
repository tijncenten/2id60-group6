...
urlpatterns = [
    ...
    url(r'^my-profile$', views.indexView, name='index'), # Temporary
    url(r'^profile/(?P<pk>[0-9]+)$', views.indexView, name='index'),
    url(r'^chats$', views.indexView, name='index'),
    url(r'^chats/(?P<pk>[0-9]+)$', views.indexView, name='index'),
    url(r'^settings$', views.indexView, name='index'),
